...
#moving robot in circular path
rate = rospy.Rate(2)
move = Twist()
move.linear.x = 0.2
move.angular.z = 0.5

#Variables and arrays decleration
odom=0
noise_yaw = []
noise_angular = []
...
def callback(msg):
	...
	#convert from quaternion representation to Roll/Pitch/Yaw
